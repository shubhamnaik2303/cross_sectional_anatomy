...
const L2 = () => {
  ...
  const handleNext = () => {
    navigate('/abdomen/l3'); // Adjust this to the correct route
  };
  ...
  return (
    <div className="level1-container-unique">
      <h1 className="level1-title-unique">Cross Sectional Abdomen Anatomy - Level L2</h1>
      ...
      <div className="level1-images-row-unique">
        ...
        <figure className="image-container">
          <img src="/images/Level_L2 _MRI.jpg" alt="Brain Image 1" className="responsive-img hover-img" />
        ...
        {/* Image 2 */}
        <figure className="image-container">
          <img src="/images/Level L 2.png" alt="Brain Image 2" className="responsive-img hover-img" />
        ...
        {/* Image 3 */}
        <figure className="image-container">
          <img src="/images/Level L2 - CT.jpg" alt="Brain Image 3" className="responsive-img hover-img" />
