...
const T12_L1 = () => {
  ...
  const handleNext = () => {
    navigate('/abdomen/l1'); // Adjust this to the correct route
  };

  const handlePrevious = () => {
    navigate('/abdomen/t11'); // Adjust this to the correct route
  };

  return (
    <div className="level1-container-unique">
      <h1 className="level1-title-unique">Cross Sectional Abdomen Anatomy - Level T12-L1</h1>
      ...
      <div className="level1-images-row-unique">
        ...
        <figure className="image-container">
          <img src="/images/Level_T12 _L1_MRI.jpg" alt="Brain Image 1" className="responsive-img hover-img" />
        ...
        {/* Image 2 */}
        <figure className="image-container">
          <img src="/images/Level T12 - L1.png" alt="Brain Image 2" className="responsive-img hover-img" />
        ...
        {/* Image 3 */}
        <figure className="image-container">
          <img src="/images/Level T12 -L1 - CT.jpg" alt="Brain Image 3" className="responsive-img hover-img" />
